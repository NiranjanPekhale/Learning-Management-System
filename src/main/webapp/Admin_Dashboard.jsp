<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="modelclass.Admin"%>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="container text-center">
						<img src="admin_profile_pic/<%=auser.getProfile()%>" class="img-fluid"
							style="border-radius: 50%; max-width: 100px;"><br>
						<h5><%=auser.getAdmin_name()%></h5>
						<br>
						<!--  table for details -->
						<div id="showProfile">
							<table class="table">
								<tbody>
									...
									<tr>
										<td>Address:</td>
										<td><%=auser.getAdmin_address()%></td>
									</tr>
									<tr>
										<td>Email:</td>
										<td><%=auser.getAdmin_email()%></td>
									</tr>
									<tr>
										<td>Mobile:</td>
										<td><%=auser.getAdmin_MobNo()%></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div id="editProfile" style="display: none;">
							<form action="Edit_Admin_Profile" method="post" enctype="multipart/form-data">
								<table class="table">
									<tbody>
										<tr>
										...
										<tr>
											...
											<td><input type="text" class="form-control" name="username"
												value="<%= auser.getUsername()%>" required="required"></td>
										</tr>
										
										<tr>
											<td>Address:</td>
											<td><input type="text" class="form-control" name="address"
												value="<%=auser.getAdmin_address()%>"></td>
										</tr>
										<tr>
											<td>Email:</td>
											<td><input type="email" class="form-control" name="email"
												value="<%=auser.getAdmin_email()%>"></td>
										</tr>
										<tr>
											<td>Mobile:</td>
											<td><input type="text" class="form-control" name="mobile"
												value="<%=auser.getAdmin_MobNo()%>"></td>
										</tr>
										<tr>
											<td>Password:</td>
											<td><input type="password" class="form-control" name="password"
												value="<%=auser.getPassword()%>" required="required"></td>
										</tr>
